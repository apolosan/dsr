...
describe("SimpleManagerBsc", async () => {
		let signers, manager;

		beforeEach(async () => {
				signers = await ethers.getSigners();
				Manager = await ethers.getContractFactory("SimpleManagerBsc");
		...
		it(`should adjust the exposure according to the price movement`, async () => {
			const SimpleManagerBscMOCK = await ethers.getContractFactory("SimpleManagerBscMOCK");
			const managerMock = await SimpleManagerBscMOCK.deploy(
				networkData.Contracts.ExchangeRouter,
				networkData.Contracts.Comptroller,
				networkData.Contracts.PriceFeed,
				networkData.Contracts.Assets,
